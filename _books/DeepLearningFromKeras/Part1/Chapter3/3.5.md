...
1986년에 로이터에서 공개한 짧은 뉴스 기사와 토픽의 집합인 **로이터 데이터셋**을 사용하겠습니다.[^1] 이 데이터셋은 텍스트 분류를 위해 널리 사용되는 간단한 데이터셋입니다. 46개의 토픽이 있으며 어떤 토픽은 다른 것에 비해 데이터가 많습니다. 각 토픽은 훈련 세트에 최소한 10개의 샘플을 가지고 있습니다.
...
![122](https://tensorflowkorea.files.wordpress.com/2018/12/122.jpg?w=625)  
_그림 3-9. 훈련과 검증 손실_
...
![123](https://tensorflowkorea.files.wordpress.com/2018/12/123.jpg?w=625)  
...
- N개의 클래스로 데이터 포인트를 분류하려면 네트워크의 마지막Dense 층의 크기는N이어야 합니다.
