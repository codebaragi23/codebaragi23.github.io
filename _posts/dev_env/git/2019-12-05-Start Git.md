...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic1.png)

### 2. 계정 정보 입력  
사용자 이름과 이메일 주소, 비밀번호를 입력하여 계정을 등록 합니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic2.png)

### 3. 계정 검사
자동 가입 방지를 위해 계정 검사를 진행하게됩니다. 검증하기를 눌러 가이드에 따라 화살표로 이미지를 움직여 바로하고 완료를 클릭합니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic3.png)

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic4.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic5.png)


### 5. 설문 조사
설문 조사 항목이 나옵니다. 가이드에 따라 skip을 하거나 설정을 완료하시면 됩니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic6.png)

### 6. 이메일 계정 확인
가입한 이메일 주소로 온 메일을 확인하면 가입 절차가 완료됩니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic7.png)

메일을 받지 못한 경우 Resend를 눌러 다시 메일을 받을 수 있습니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic8.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic9.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic10.png)

 **2. 설치할 Component들을 선택합니다.**
 저는 기본으로 선택되어 있는것 이외에는 추가로 설치하지않고 Next를 눌러 진행하겠습니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic11.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic12.png)

 **4. 환경 설정을 위한 페이지입니다.**
Use Git from the Windows Command Prompt를 선택하고 Next를 하겠습니다.

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic13.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic14.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic15.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic16.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic17.png)
...
![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic18.png)

 **10. 설치가 완료되었습니다.**

![](/assets/images/posts/dev_env/git/2019-12-05-Start Git-pic19.png)
